...
const rides_service_1 = require("./src/rides/rides.service");
async function bootstrap() {
    const app = await core_1.NestFactory.createApplicationContext(app_module_1.AppModule);
    const prisma = app.get(prisma_service_1.PrismaService);
    const redis = app.get(redis_service_1.RedisService);
    const ridesService = app.get(rides_service_1.RidesService);
...
bootstrap();
//# sourceMappingURL=simulate-concurrency.js.map